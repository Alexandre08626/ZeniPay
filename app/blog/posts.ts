...
export const POSTS: BlogPost[] = [
  {
    ...
    body: [
      ...
      "ZeniPay was built the other way around. Every account ships with the fleet on day one. The agents read live data through scoped, audited tool calls. The signed audit trail and the access controls are infrastructure — not features added later.",
