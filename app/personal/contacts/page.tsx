// /personal/contacts — saved-payee list for the Personal mode.
//
// Shares the same zenipay_contacts table as /app/contacts (one row
// per merchant_id, regardless of business vs personal mode), so a
// recipient added on either side shows up on both. Pink-accented
// shell + primary button to match Personal mode's visual language.
...
export default function PersonalContactsPage() {
  ...
  return (
    <DashboardShell mode="personal">
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 18, flexWrap: "wrap", gap: 10 }}>
        <div>
          ...
          <p style={{ margin: "4px 0 0", color: zp.text.muted, fontSize: 13 }}>
            {contacts.length} {contacts.length === 1 ? "saved payee" : "saved payees"} · friends, family, suppliers
          </p>
        </div>
        <GradientButton
      ...
      <BankingCard padding="none" accent="pink">
        <DataTable
          rows={filtered}
          ...
          empty={
            <div>
              ...
              <p style={{ margin: "0 0 12px", color: zp.text.muted, fontSize: 13 }}>
                Save the people and businesses you send money to. Then send in one click from <code style={{ background: zp.surface.bg2, padding: "2px 6px", borderRadius: 4 }}>/personal/wallets</code>.
              </p>
              <GradientButton
    ...
    >
      ...
      >
        <div style={{ padding: "20px 24px", borderBottom: `1px solid ${zp.surface.border}`, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            <h2 style={{ margin: 0, fontWeight: zp.weight.semibold, fontSize: 18, color: zp.text.primary }}>Add contact</h2>
            <p style={{ margin: "2px 0 0", fontSize: 12, color: zp.text.muted }}>Save people and businesses you send money to.</p>
          </div>
        ...
        <div style={{ padding: 22 }}>
          ...
          <Input value={name} onChange={setName} placeholder="e.g. Maman, Loyer, Acme Inc." />
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    border: `1.5px solid ${active ? zp.brand.pink : zp.surface.border}`,
                    background: active ? "rgba(255,107,157,0.08)" : zp.surface.bg2,
                  }}
                >
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 22 }}>
            ...
            <GradientButton
              ...
              style={{ flex: 1, background: zp.gradient.personal }}
            >
